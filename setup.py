...
setup(
	name="godel-program-converter",
	version="0.0.1",
	author="Jonah Lawrence",
	author_email="jonah@freshidea.com",
	description="Program to convert a program encoding based on its Gödel number to 𝒮 Language (S Language) or convert an 𝒮 Language program to its program number",
	long_description=long_description(),
	long_description_content_type="text/markdown",
	url="https://github.com/DenverCoder1/godel-program-converter",
	project_urls={
		"Bug Tracker": "https://github.com/DenverCoder1/godel-program-converter/issues",
	},
	packages=["src", "tests"],
	classifiers=[
